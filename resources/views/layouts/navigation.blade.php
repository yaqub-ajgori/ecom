@php
    // Retrieve user role (assuming role: 0 = admin, 1 = vendor, 2 = regular user)
    $authUserRole = Auth::user()->role;

    // Determine which dashboard route to use based on the role
    $dashboardRoute =
        $authUserRole == 0
...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <!-- Use the dynamic route for the dashboard -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <!-- Responsive Dynamic Dashboard Link based on user role -->
